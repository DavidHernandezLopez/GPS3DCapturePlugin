...
class GPS3DCapturePlugin:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'GPS3DCapturePlugin_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&GPS 3D Capture Plugin')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'GPS3DCapturePlugin')
        self.toolbar.setObjectName(u'GPS3DCapturePlugin')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('GPS3DCapturePlugin', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/GPS3DCapturePlugin/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'GPS 3D Capture Plugin'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&GPS 3D Capture Plugin'),
                action)
